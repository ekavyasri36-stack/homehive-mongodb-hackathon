...
const services = [
  {
    id: 1,
    title: "Home Cleaning",
    description: "Deep cleaning for a fresh and comfortable home.",
    icon: "🧹",
    color: "blue",
    price: "From ₹499"
  },
  {
    id: 2,
    title: "Plumbing",
    description: "Reliable solutions for leaks, pipes and fittings.",
    icon: "🔧",
    color: "purple",
    price: "From ₹299"
  },
  ...
  },
  {
    id: 4,
    title: "AC Service",
    description: "Keep your cooling system efficient and clean.",
    icon: "❄️",
    color: "cyan",
    price: "From ₹599"
  },
  {
    id: 5,
    title: "Painting",
    description: "Give your walls a beautiful new appearance.",
    icon: "🎨",
    color: "pink",
    price: "From ₹1,499"
  },
  {
    ...
    description: "Professional support for household appliances.",
    icon: "⚙️",
    color: "green",
    price: "From ₹399"
  }
...
function App() {
  ...
  // Emergency Assistance -> Backend -> MongoDB
  const submitEmergencyRequest = async () => {
    if (!emergencyType) {
      return showToast(
        "Please select who needs emergency assistance"
      );
    }

    if (!emergencyContact.trim()) {
      return showToast("Please enter a contact number");
    }

    if (!emergencyLocation.trim()) {
      return showToast("Please enter the current location");
    }
    ...
    try {
      ...
      showToast("Emergency assistance request saved");
    } catch (error) {
      console.error(
  ...
  return (
    <div className="app">
        ...
        <section className="page-content">
          ...
          {activePage === "Dashboard" ? (
            <>
              ...
              <div className="welcome-section">
                ...
                <div>
                  ...
                  <p>
                    ...
                    organized in one peaceful space.
                  </p>
                </div>
              ...
              <div className="stats-grid">
                ...
                <Stat
                  ...
                  value="98%"
                  desc="Based on completed services"
                  positive
                />
              ...
              <div className="dashboard-grid">
                ...
                <div className="assistant-card">
                  ...
                  <div className="assistant-visual">
                    ...
                    <div className="anime-character">
                      ...
                      <div className="anime-face">
                        <div className="anime-eye left-eye" />
                        <div className="anime-eye right-eye" />
                    ...
                    <span className="floating-spark spark-one">
                      ✦
                    </span>

                    <span className="floating-spark spark-two">
                      ✧
                    </span>
                  ...
                  <div className="assistant-text">
                    ...
                    <p>
                      I can help you find services,
                      track bookings, and keep your
              ...
              <div className="emergency-section">
                ...
                <div className="emergency-card">
                  ...
                  <div className="emergency-content">
                    ...
                    <h2>
                      Someone at home needs urgent help?
                    </h2>

                    <p>
                      HomeHive can create an
                      assistance request for people
                ...
                <div className="services-grid">
                  ...
                  {filteredServices.map((s) => (
                    ...
                    >
                      ...
                      <div
                        className={`service-icon ${s.color}`}
                      >
                        <span>{s.icon}</span>
              ...
              <div className="bottom-banner">
                ...
                <div>
                  <h3>
                    Your home deserves dependable care.
                  </h3>
                ...
                <button
                  ...
                  onClick={() =>
                    showToast(
                      "Learn more section coming soon"
                    )
                  }
                >
                  Learn more
            ...
            <div className="placeholder-page">
              ...
              <p>
                This section is ready for your
        ...
        selectedService && (
          ...
          >
            <div className="booking-modal">
              ...
              <p>
                Tell us when you would like a
                professional to visit your home.
              </p>
      ...
      {showEmergencyModal && (
        ...
        >
          <div className="booking-modal emergency-modal">
            ...
            {!emergencySubmitted ? (
              <>
                ...
                <div className="modal-icon emergency-modal-icon">
                  <HeartPulse size={32} />
                </div>
                ...
                <div className="emergency-warning">
                  ...
                  <span>
                    ...
                    HomeHive assistance does not
                    replace ambulance, medical,
                    police or rescue services.
                  </span>
                ...
                <textarea
                  placeholder="Briefly describe what assistance is needed..."
                ...
                <button
                  className="primary-button full-width emergency-submit"
                  onClick={
              ...
              <div className="emergency-success">
                ...
                <p>
                  Your HomeHive emergency
                  assistance request has been
                  recorded. Please remain in a
                  safe place and contact local
      ...
      <div
        className={`cursor-companion mood-${avatarMood}`}
      >
        ...
        <div className="cute-bunny">
          ...
          <div className="bunny-head">
            ...
            <div
              className={`bunny-face expression-${avatarMood}`}
            >
          ...
          <div className="bunny-body">
            <span className="bunny-belly" />
            <span className="bunny-star">
              ✦
            </span>
          </div>

          <span className="bunny-foot bunny-foot-left" />
          <span className="bunny-foot bunny-foot-right" />
